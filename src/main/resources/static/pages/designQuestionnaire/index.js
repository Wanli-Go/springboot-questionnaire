...
let questionnaireTitle = sessionStorage.getItem("surveyName");
let questionnaireDescription = sessionStorage.getItem("surveyDescription")

document.getElementById("title").innerHTML = questionnaireTitle;
document.getElementById("description").innerHTML = questionnaireDescription;
...
const onAddQuestion = (type) => {
  ...
  $('#problem').append(ele)
  problem.push({ problemName: '', mustAnswer: true, option: [{}], type: '' })
...
const preview = () => {
  localStorage.setItem('problems', JSON.stringify(problem));
  ...
  const iframe = document.getElementById('surveyIframe');
    ...
    iframe.src = './modules/previewModal/index.html';
...
const singleChoiceEditFinish = (problemIndex) => {
  problem[problemIndex].type = 'single'
  $(`#question${problemIndex} .bottom`).css('display', 'none')
...
const multipleChoiceEditFinish = (problemIndex) => {
  problem[problemIndex].type = 'multiple'
  $(`#question${problemIndex} .bottom`).css('display', 'none')
  $(`#question${problemIndex} .bottom2`).css('display', 'inline')
  $(`#question${problemIndex} #questionTitle`).text(`${problemIndex + 1}.${problem[problemIndex].problemName}`)
  $(`#question${problemIndex} .bottom2`).html('')
...
const matrixEditFinish = (problemIndex) => {
  problem[problemIndex].type = 'matrix'
  $(`#question${problemIndex} .bottom`).css('display', 'none')
  $(`#question${problemIndex} .bottom2`).css('display', 'inline')
  $(`#question${problemIndex} #questionTitle`).text(`${problemIndex + 1}.${problem[problemIndex].problemName}`)
  $(`#question${problemIndex} .bottom2`).html('')
...
const gaugeEditFinish = (problemIndex) => {
  problem[problemIndex].type = 'gauge'
  $(`#question${problemIndex} .bottom`).css('display', 'none')
...
const handleEditFinish = () => {
  ...
  let type = sessionStorage.getItem('surveyType');
  let id = sessionStorage.getItem('qstId');
  if(id == null){
    console.error("no qstId found");
    return;
  }
